...
Do not place raw HTML tags inside mathematical expressions. GitHub may parse them as HTML before MathJax processes the expression.
...
When reliability is more important than typographic fidelity, replace fragile mathematical notation with plain text.
